...
const DRAW_RESULTS_URI = {
  ...
  42161: `${DRAW_RESULTS_PROTOCOL_AND_HOSTNAME}/${DRAW_RESULTS_ORG_AND_REPO}`,
  421614: `${DRAW_RESULTS_PROTOCOL_AND_HOSTNAME}/${DRAW_RESULTS_TESTNET_ORG_AND_REPO}`,
  11155420: `${DRAW_RESULTS_PROTOCOL_AND_HOSTNAME}/${DRAW_RESULTS_TESTNET_ORG_AND_REPO}`,
};
