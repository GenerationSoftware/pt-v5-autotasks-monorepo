...
function t() {
  ...
  var e = {},
    ...
    y = s.asyncIterator || "@@asyncIterator",
  ...
  function d(e, t, n, a) {
    var s = Object.create((t && t.prototype instanceof m ? t : m).prototype),
      p = new A(a || []);
    return i(s, "_invoke", { value: h(e, n, p) }), s;
  }
  function o(e, t, n) {
    try {
  ...
  var f = Object.getPrototypeOf,
    v = f && f(f(C([])));
  v && v !== n && a.call(v, p) && (b = v);
  var w = (c.prototype = m.prototype = Object.create(b));
  function M(e) {
  ...
  return (
    (T.prototype = c),
    i(w, "constructor", { value: c, configurable: !0 }),
    i(c, "constructor", { value: T, configurable: !0 }),
    (T.displayName = r(c, u, "GeneratorFunction")),
    ...
    (e.mark = function(e) {
      return (
        Object.setPrototypeOf
          ...
          : ((e.__proto__ = c), r(e, u, "GeneratorFunction")),
    ...
    M(x.prototype),
    r(x.prototype, y, function() {
      return this;
    }),
    (e.AsyncIterator = x),
    (e.async = function(t, n, a, i, s) {
      void 0 === s && (s = Promise);
      var p = new x(d(t, n, a, i), s);
      return e.isGeneratorFunction(n)
        ? p
        : p.next().then(function(e) {
    ...
    (A.prototype = {
      ...
      dispatchException: function(e) {
        ...
        for (var i = this.tryEntries.length - 1; i >= 0; --i) {
          ...
          if (s.tryLoc <= this.prev) {
            var y = a.call(s, "catchLoc"),
              u = a.call(s, "finallyLoc");
            if (y && u) {
      ...
      abrupt: function(e, t) {
        ...
        s &&
          ...
          t <= s.finallyLoc &&
          (s = null);
        var p = s ? s.completion : {};
        return (
          (p.type = e),
          (p.arg = t),
          s ? ((this.method = "next"), (this.next = s.finallyLoc), l) : this.complete(p)
        );
      },
      ...
      finish: function(e) {
        for (var t = this.tryEntries.length - 1; t >= 0; --t) {
          ...
          if (n.finallyLoc === e) return this.complete(n.completion, n.afterLoc), R(n), l;
        }
      },
      catch: function(e) {
        for (var t = this.tryEntries.length - 1; t >= 0; --t) {
...
function n(e, t, n, a, i, s, p) {
  ...
  y.done ? t(u) : Promise.resolve(u).then(a, i);
}
function a(e) {
  return function() {
    var t = this,
...
var i = require("debug")("pt-autotask-lib");
function s(t, n, a, s, p) {
  if (
    (void 0 === p && (p = { major: 1, minor: 0, patch: 0 }),
    i("name:", t),
    i("chainId:", n),
    !t || !n)
  )
  ...
  for (
    var y = s.contracts
        .filter(function(e) {
          return e.type === t && e.chainId === n;
        })
        .filter(function(e) {
          return JSON.stringify(e.version) === JSON.stringify(p);
        }),
      u = [],
      r = 0;
    r < y.length;
    ...
    var d = y[r];
    d && u.push(new e.ethers.Contract(d.address, d.abi, a));
  }
  if (0 === u.length)
    throw new Error("Multiple Contracts Unavailable: " + t + " on chainId: " + n + " ");
  return u;
}
function p(e, t, n, a, i) {
  return void 0 === i && (i = { major: 1, minor: 0, patch: 0 }), s(e, t, n, a, i)[0];
}
function y() {
  return (y = a(
    t().mark(function e(n, a, i) {
      var y, d, o, l, m, T, c, b;
      return t().wrap(function(e) {
        for (;;)
          switch ((e.prev = e.next)) {
            case 0:
              if (
                ((o = p("Claimer", (y = a.chainId), (d = a.provider), n)),
                (l = s("Vault", y, d, n)),
                console.log(l),
                o)
              ) {
            ...
            case 18:
              return console.log("feeData ? ", e.sent), (e.next = 22), o.callStatic.claimPrize(b);
            case 22:
              return console.log("earnedFees ? ", e.sent), (e.next = 26), u(o, b);
            case 26:
              console.log("gasEstimate ? ", e.sent), (e.next = 38);
              break;
            case 34:
              (e.t1 = e.sent), e.t0.push.call(e.t0, e.t1), (e.next = 39);
              break;
            case 38:
              console.log("Claimer: No Prizes found to claim for Vault: " + c.address + ".");
            case 39:
              T++, (e.next = 10);
              break;
            case 42:
...
var u = (function() {
      ...
      t().mark(function e(n, a) {
        return t().wrap(function(e) {
          for (;;)
            switch ((e.prev = e.next)) {
              case 0:
                return (e.next = 2), n.estimateGas.claimPrize(a);
              case 2:
        ...
        return t().wrap(function(t) {
          for (;;)
            switch ((t.prev = t.next)) {
              case 0:
                return (t.next = 2), a.getFeeData();
              case 2:
                return t.abrupt("return", e.ethers.utils.formatUnits(t.sent.maxFeePerGas, "gwei"));
              case 4:
              case "end":
                return t.stop();
            }
  ...
  d = require("debug")("pt-autotask-lib");
function o() {
  return (o = a(
    t().mark(function e(n, a) {
      var i, s, y, u, r, o, l, m, T, c, b;
      return t().wrap(function(e) {
        for (;;)
          switch ((e.prev = e.next)) {
            case 0:
              if ((i = p("DrawBeacon", a.chainId, a.provider, n))) {
                e.next = 4;
                break;
              }
              throw new Error("DrawBeacon: Contract Unavailable");
            case 4:
              return (e.next = 6), i.getNextDrawId();
            case 6:
              return (s = e.sent), (e.next = 9), i.beaconPeriodEndAt();
            case 9:
              return (y = e.sent), (e.next = 12), i.getBeaconPeriodStartedAt();
            case 12:
              return (u = e.sent), (e.next = 15), i.isRngRequested();
            case 15:
              return (r = e.sent), (e.next = 18), i.isRngCompleted();
            case 18:
              return (o = e.sent), (e.next = 21), i.isRngRequested();
            case 21:
              return (l = e.sent), (e.next = 24), i.getBeaconPeriodSeconds();
            case 24:
              return (m = e.sent), (e.next = 27), i.canStartDraw();
            case 27:
              return (T = e.sent), (e.next = 30), i.canCompleteDraw();
            case 30:
              if (
                ((c = e.sent),
                d("DrawBeacon next Draw.drawId:", s),
                d("DrawBeacon Beacon PeriodStartedAt:", u.toString()),
                d("DrawBeacon Beacon PeriodSeconds:", m.toString()),
                d("DrawBeacon Beacon PeriodOver:", l),
                d("Is RNG Requested:", r),
                d("Can Start Draw:", T),
                d("Can Complete Draw:", c),
                !T)
              ) {
                e.next = 45;
                break;
              ...
              return (
                ...
                (e.next = 42),
                i.populateTransaction.startDraw()
              );
            case 42:
              (b = e.sent), (e.next = 46);
              break;
            case 45:
              c ||
                console.log(
                  "DrawBeacon: Draw " + s + " not ready to start.\nBeaconPeriodEndAt: " + y
                );
            case 46:
              if (!c) {
                e.next = 53;
              ...
              return (
                ...
                (e.next = 50),
                i.populateTransaction.completeDraw()
              );
            case 50:
              (b = e.sent), (e.next = 54);
              break;
...
var l = require("debug")("pt-autotask-lib");
function m() {
  return (m = a(
    t().mark(function n(a, i, p, y) {
      var u, r, d, o, m, T, c, b, f, v;
      return t().wrap(function(t) {
        for (;;)
          switch ((t.prev = t.next)) {
            case 0:
              if (0 !== (r = s("LiquidationPair", i.chainId, (u = i.provider), a)).length) {
                t.next = 4;
                break;
              }
              throw new Error("LiquidationPairs: Contracts Unavailable");
            case 4:
              return (d = r[0]), (t.next = 7), d.callStatic.maxAmountOut();
            case 7:
              return (
                (o = t.sent),
                console.log("maxAmountOut ", o),
                console.log(p),
                (t.next = 12),
                d.callStatic.swapExactAmountIn(p, e.BigNumber.from(10), o)
              );
            case 12:
              return (
                console.log("swapExactAmountInComputed ", t.sent),
                (m = "MOCK"),
                (t.next = 18),
                d.maxAmountOut()
              );
            case 18:
              return (
                ...
                (c = o),
                (t.next = 24),
                d.computeExactAmountIn(T)
              );
            case 24:
              if (
                ((f = 1.02 * (b = t.sent)),
                l("LiquidationPair computed amount out:", T),
                !(f - 0.1 > 1))
              ) {
                t.next = 37;
                break;
              }
              return (t.next = 33), d.populateTransaction.swapExactAmountIn(u, b, c);
            case 33:
              (v = t.sent), console.log("LiquidationPair: Swapping"), (t.next = 38);
              break;
            case 37:
    ...
    t().mark(function e(n, a) {
      ...
      return t().wrap(function(e) {
        for (;;)
          switch ((e.prev = e.next)) {
            case 0:
              (i = s("YieldVault", a.chainId, a.provider, n)), (p = []), (y = 0);
            case 4:
              if (!(y < i.length)) {
                e.next = 17;
                break;
            ...
            case 8:
              return (
                ...
                (e.t0 = p),
                (e.next = 12),
                u.populateTransaction.mintRate()
              );
            case 12:
    ...
    t().mark(function e(n, a) {
      ...
      return t().wrap(function(e) {
        for (;;)
          switch ((e.prev = e.next)) {
            case 0:
              if ((i = p("PrizePool", a.chainId, a.provider, n))) {
                e.next = 4;
                break;
              }
              throw new Error("TestNet PrizePool: Contract Unavailable");
            case 4:
              return (e.next = 6), i.nextDrawEndsAt();
            case 6:
              if (
                ((s = e.sent),
                (y = Date.now() / 1e3 > s),
                console.log("Next draw ends at:", s),
                console.log("Date.now():", Date.now()),
                console.log("Can Complete Draw:", y),
                !y)
              ) {
                e.next = 19;
                break;
              ...
              return (
                ...
                (r = Math.floor(Math.random() * Math.pow(10, 10))),
                (e.next = 16),
                i.populateTransaction.completeAndStartNextDraw(r)
              );
            case 16:
              (u = e.sent), (e.next = 20);
              break;
...
(exports.claimerHandleClaimPrize = function(e, t, n) {
  return y.apply(this, arguments);
}),
  (exports.drawBeaconHandleDrawStartAndComplete = function(e, t) {
    return o.apply(this, arguments);
  }),
  (exports.getContract = p),
  (exports.getContracts = s),
  (exports.liquidatorHandleArbSwap = function(e, t, n, a) {
        ...
        abi: [
          {
            ...
            inputs: [
              ...
              { indexed: !1, internalType: "uint112", name: "amount", type: "uint112" },
              { indexed: !1, internalType: "uint112", name: "delegateAmount", type: "uint112" },
              { indexed: !1, internalType: "bool", name: "isNew", type: "bool" },
              {
                components: [
          ...
          },
          {
            ...
            inputs: [
              { indexed: !0, internalType: "address", name: "vault", type: "address" },
              { indexed: !0, internalType: "address", name: "delegator", type: "address" },
              { indexed: !0, internalType: "address", name: "delegate", type: "address" }
            ],
            name: "Delegated",
            type: "event"
          },
      ...
      },
      {
        ...
        abi: [
          ...
          },
          {
            anonymous: !1,
            inputs: [
              { indexed: !0, internalType: "uint32", name: "drawId", type: "uint32" },
              { indexed: !0, internalType: "address", name: "vault", type: "address" },
              { indexed: !0, internalType: "address", name: "winner", type: "address" },
              { indexed: !1, internalType: "uint8", name: "tier", type: "uint8" },
              { indexed: !1, internalType: "uint152", name: "payout", type: "uint152" },
              { indexed: !1, internalType: "address", name: "to", type: "address" },
              { indexed: !1, internalType: "uint96", name: "fee", type: "uint96" },
        ...
        abi: [
          {
            ...
            inputs: [
              ...
              { indexed: !0, internalType: "address", name: "tokenIn", type: "address" },
              { indexed: !1, internalType: "address", name: "tokenOut", type: "address" },
              { indexed: !1, internalType: "UFixed32x9", name: "swapMultiplier", type: "uint32" },
              {
                indexed: !1,
              ...
              { indexed: !1, internalType: "uint128", name: "virtualReserveIn", type: "uint128" },
              { indexed: !1, internalType: "uint128", name: "virtualReserveOut", type: "uint128" }
            ],
            name: "PairCreated",
            type: "event"
          },
        ...
        abi: [
          ...
          },
          {
            ...
            inputs: [
              { indexed: !0, internalType: "address", name: "sender", type: "address" },
              { indexed: !0, internalType: "address", name: "owner", type: "address" },
              { indexed: !1, internalType: "uint256", name: "assets", type: "uint256" },
        ...
        abi: [
          ...
          },
          {
            ...
            inputs: [
              ...
              { indexed: !1, internalType: "bool", name: "status", type: "bool" }
            ],
          ...
          },
          {
            anonymous: !1,
            inputs: [
              { indexed: !0, internalType: "contract IERC20", name: "asset", type: "address" },
              ...
              { indexed: !1, internalType: "contract Claimer", name: "claimer", type: "address" },
          ...
          },
          {
            anonymous: !1,
            inputs: [
              { indexed: !0, internalType: "address", name: "pendingOwner", type: "address" }
            ],
  ...
  (exports.testnetPrizePoolHandleCompletePrize = function(e, t) {
    return c.apply(this, arguments);
  }),
  (exports.yieldVaultHandleMintRate = function(e, t) {
    return T.apply(this, arguments);
  });
//# sourceMappingURL=v5-autotasks-library.cjs.production.min.js.map
